  ...
  return (
    <div className="p-0 bg-gray-50 flex-grow">
      <div className="p-6 flex flex-col gap-6">
        <header className="flex items-center gap-4 bg-primary p-4">
            <div className="icon"><GraduationCap className="text-white w-10 h-10"/></div>
            <div className="font-inter">
                <p className="font-semibold text-white text-[2rem] capitalize">Diplomas</p>
            </div>  
        </header>
